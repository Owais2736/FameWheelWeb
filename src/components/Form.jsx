          ...
          <div className="bg-white rounded-lg shadow-md p-5">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 ">
              ...
              <div className="p-2  rounded-lg">
                ...
                <button className='w-[120px] text-[14px] lg:text-[18px] md:w-[150px] xl:w-[230px] h-[38px] ml-3 rounded-lg border-2 border-red-200  text-gray-600'>Advanced Search</button>
              </div>
