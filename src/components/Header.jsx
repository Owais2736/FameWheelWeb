...
function Header() {
  ...
  return (
    <>
      <div className={`absolute top-0 left-0 gap-[570px] w-full ${bgClass} h-[40px] text-white flex justify-around items-center transition-all duration-300`}>
        <div className="flex gap-2 items-center">
          <div>
            <img width={30} height={6} src="Images/header/flag.png" alt="" />
          </div>
          <div>Pakistan</div>
        </div>
