    ...
    <div className="max-w-screen-2xl mx-auto px-6 md:px-8 lg:px-12 xl:px-16">
      <div className="font-sans p-4">
        ...
        <ul className="flex border-b">
          <li
            className={`tab text-[15px] py-2.5 px-5 cursor-pointer ${activeTab === 'home' ? 'text-red-900 font-bold border-b-2 border-red-900' : 'text-gray-600 font-semibold border-b-2 border-transparent'
              }`}
          ...
          <li
            className={`tab text-[15px] py-2.5 px-5 cursor-pointer ${activeTab === 'setting' ? 'text-red-900 font-bold border-b-2 border-red-900' : 'text-gray-600 font-semibold border-b-2 border-transparent'
              }`}
