...
function StatsSection() {
  return (
    <div className="p-8 font-sans bg-gradient-to-r from-pink-600 to-purple-900">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          ...
          <div className="text-center flex items-center gap-1">
            ...
            <div>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="70" height="70" color="white" fill="none">
    ...
    <path d="M16.8825 15L17.5527 18.2099C17.9833 20.2723 18.1986 21.3035 17.7563 21.7923C17.3141 22.281 16.546 21.8606 15.0099 21.0198L12.7364 19.7753C12.3734 19.5766 12.1919 19.4773 12 19.4773C11.8081 19.4773 11.6266 19.5766 11.2636 19.7753L8.99008 21.0198C7.45397 21.8606 6.68592 22.281 6.24365 21.7923C5.80139 21.3035 6.01669 20.2723 6.44731 18.2099L7.11752 15" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
            ...
            <div>
          <p className="text-base text-[25px] text-white  font-bold mt-2">Pakistan’s No 1</p>
          <p className="text-sm text-white ">Live Bidding Portal</p></div>
        </div>
...
<div><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="70" height="70" color="white" fill="none">
...
<p className="text-base text-[25px]  text-white font-bold mt-2">Car Sold</p>
<p className="text-sm text-white">Every 15 Minutes</p></div>
</div>
...
<div>
<p className="text-base text-[25px]  text-white font-bold mt-2">Offers</p>
<p className="text-sm text-white">Stay updated pay less</p></div>
</div>
    ...
    <path d="M15.502 9.996L21.4055 13.38M21.4055 13.38C21.7255 13.0406 21.1848 12.06 20.7283 10.728M21.4055 13.38C21.1848 13.62 20.4639 13.68 18.7639 13.998" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
</svg>
            </div>
            <div>
          <p className="text-base text-[25px]  text-white font-bold mt-2">Compare</p>
          <p className="text-sm text-white">Decode the right car</p></div>
        </div>
